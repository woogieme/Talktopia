	...
	public static void infiniteStreamingRecognize(String languageCode) throws Exception {
		...
		try (SpeechClient client = SpeechClient.create()) {
			...
			try {
				...
				long startTime = System.currentTimeMillis(); // 현재시간은 시작시간

				// 마이크 인식
				while (true) {

					long estimatedTime = System.currentTimeMillis() - startTime; // 말하는데 걸린 시간

					if (estimatedTime >= STREAMING_LIMIT) { // 스트리밍 제한시간을 넘어섬
